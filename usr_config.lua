...
config.BOOT_SIMULATE_MR = false         -- production: MCU MR is the only startup report to server
...
config.NAT_INTERVAL    = 30 * 1000      -- 30s UDP heartbeat keeps carrier NAT mapping alive
config.HB_ACK_MISS_LIMIT = 2            -- rebuild UDP socket after this many missed heartbeat ACKs
config.SOCKET_CONNECT_FAIL_LIMIT = 3    -- reattach cellular network after this many socket connect failures
